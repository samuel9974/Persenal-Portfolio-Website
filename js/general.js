...
/*--------------------------------------------------------------------------------------------------------------------------------------*/		
		...
		if($('.portfolio-slider').length) {
			...
			var $portCarousel = $('#portfolio .portfolio-slider');
			if ($portCarousel.length && typeof $.fn.magnificPopup === 'function') {
				try {
					$portCarousel.magnificPopup('destroy');
				} catch (ignore) {
		...
		popup
		=============================*/
		// Portfolio Demo/GitHub: beat any Magnific "image gallery" that still hooks these links (mobile).
